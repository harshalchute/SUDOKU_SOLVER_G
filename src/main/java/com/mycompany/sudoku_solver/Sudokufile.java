...
public class Sudokufile extends javax.swing.JFrame {
    ...
    private void AssignTurn(JButton btn){
        selectionbtn1.setBackground(pink);
        selectionbtn2.setBackground(pink);
        selectionbtn3.setBackground(pink);
        selectionbtn4.setBackground(pink);
        selectionbtn5.setBackground(pink);
        selectionbtn6.setBackground(pink);
        selectionbtn7.setBackground(pink);
        selectionbtn8.setBackground(pink);
        selectionbtn9.setBackground(pink);
    ...
    private void Checkmoves(){
        ...
        for(int i = 0; i < 9; i++){
            for(int j = 0; j < 9; j++){
               ...
               }else if(btns[i][j].getText() == solveBoard[i][j]){
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(checkmoves, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(checkmoves, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
